...
<html lang="en">
	...
	<body id="kt_body" data-kt-aside-minimize="on" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed toolbar-tablet-and-mobile-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
				...
				<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
					...
					<div class="aside-logo flex-column-auto" id="kt_aside_logo">
						...
						<a href="../../demo13/dist/index.html">
							<img alt="Logo" src="src/media/logos/logo-demo13.svg" class="h-15px logo" />
						</a>
						<!--end::Logo-->
						<!--begin::Aside toggler-->
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link {{ Request::is('/') ? 'active' : '' }}" href="/">
										...
										<span class="menu-title">Dashboard Pasien</span>
									</a>
								</div>
								<div class="menu-item">
									<a class="menu-link {{ Request::is('CobaTampilan') ? 'active' : '' }}" href="/CobaTampilan">
										<span class="menu-icon ">
											<i class="bi bi-grid fs-3"></i>
										</span>
										<span class="menu-title">Coba Tampilkan</span>
									</a>
								</div>
							</div>
							<!--end::Menu-->
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							...
							<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
								<a href="../../demo13/dist/index.html" class="d-lg-none">
									<img alt="Logo" src="src/media/logos/logo-demo13-compact.svg" class="h-25px" />
								</a>
							</div>
							<!--end::Mobile logo-->
							<!--begin::Wrapper-->
										...
										<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
											<div class="menu-item me-lg-1">
												<a class="menu-link py-3" href="/">
													<span class="menu-title">SISTEM INFORMASI IBU HAMIL</span>
												</a>
											</div>
										</div>
										<!--end::Menu-->
									...
									<div class="topbar d-flex align-items-stretch flex-shrink-0">
										...
										<div class="d-flex align-items-stretch" id="kt_header_user_menu_toggle">
											...
											<div class="topbar-item cursor-pointer symbol px-3 px-lg-5 me-n3 me-lg-n5 symbol-30px symbol-md-35px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom">
												<img src="src/media/avatars/150-2.jpg" alt="metronic" />
											</div>
											<!--begin::Menu-->
												...
												<div class="menu-item px-3">
													<div class="menu-content d-flex align-items-center px-3">
														...
														<div class="symbol symbol-50px me-5">
															<img alt="Logo" src="src/media/avatars/150-26.jpg" />
														</div>
														<!--end::Avatar-->
														<!--begin::Username-->
		...
		<script src="{{ asset('src/js/custom/pages/projects/settings/settings.js') }}"></script>
		<script src="{{ asset('src/js/custom/modals/users-search.js') }}"></script>
		<script src="{{ asset('src/js/custom/modals/new-target.js') }}"></script>
	</body>
	<!--end::Body-->
</html>