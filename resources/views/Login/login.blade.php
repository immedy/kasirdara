...
<html lang="en">
	...
	<body body id="kt_body" class="bg-dark">
        <div class="d-flex flex-column flex-root">
			<!--begin::Authentication - Sign-in -->
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(asset{{ ('src/media/illustrations/unitedpalms-1/14-dark.png') }})">
				<!--begin::Content-->
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					<!--begin::Logo-->
					<a href="../../demo13/dist/index.html" class="mb-12">
						<img alt="Logo" src="{{ asset('src/media/logos/logo-2.svg') }}" class="h-40px" />
					</a>
					<!--end::Logo-->
					<!--begin::Wrapper-->
					<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="#">
							...
							<div class="text-center mb-10">
								...
								<a href="../../demo13/dist/authentication/flows/dark/sign-up.html" class="link-primary fw-bolder">Create an Account</a></div>
								<!--end::Link-->
							</div>
							<!--begin::Heading-->
							<!--begin::Input group-->
							...
							<div class="fv-row mb-10">
								...
								<div class="d-flex flex-stack mb-2">
									...
									<!--end::Label-->
									<!--begin::Link-->
									<a href="../../demo13/dist/authentication/flows/dark/password-reset.html" class="link-primary fs-6 fw-bolder">Forgot Password ?</a>
									<!--end::Link-->
								</div>
								<!--end::Wrapper-->
								<!--begin::Input-->
